...
<div class="flex items-center justify-center h-screen flex-col">
        ...
        <div class="text-gray-800 text-4xl font-bold flex items-center mb-4">
            <span class="ml-2 font-bold">Join Quiz</span>
        </div>
        ...
        <div class="border-t border-gray-300 w-full mb-4 pt-4"></div>
            ...
            <div class="flex items-center gap-3">
                <div class="relative">
                    <i class="border-r border-gray-300 pr-2 fa-solid fa-hashtag absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500"></i>
                    <input class="w-full p-2 pl-10 rounded-md border-2 border-gray-300" type="text" name="quiz_id" placeholder="Quiz ID">
                </div>
            </div>
            </div>
            <button class="w-full p-2 rounded-md bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold" type="submit">Join Quiz</button>
            @if(isset($error))
